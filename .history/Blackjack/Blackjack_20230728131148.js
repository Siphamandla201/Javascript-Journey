...
function cardHandling() {
    ...
    if(playerSum < dealerSum && isAlive === true && dealerIsAlive === false && playerDone === true && hasBlackJack === true) {
        message = "You win";
    } else if (playerSum < dealerSum && isAlive === false && dealerIsAlive === true && playerDone === true && hasBlackJack === false) {
        message = "You lose";
    }else if (playerSum < dealerSum && isAlive === false && dealerIsAlive && playerDone === true && hasBlackJack === false) {
        message = "You lose";
    }
